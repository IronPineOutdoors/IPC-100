...
Package 10R implements Sheet 09 with the ICD-002 generic connector/harness boundaries, split STOP/UI connectors, restricted J10, USB-C device/UFP grouped contacts and CC Rd, factory pogo boundary, and J11/J12 documentation-only notes. All footprints and exact connector/protection selections remain open; native ERC is pending.
