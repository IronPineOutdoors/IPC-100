...
QER-01 subsequently released the quantitative envelope, and CSR-01A-R reattempted the freeze. Nine independent 100 kΩ Sheet 02/08 bias/enable resistors are now frozen in the EBOM; 115 power rows remain blocked by QER/schematic conflicts, composite physical functions, detailed analysis, sourcing, or J1 mechanics. No schematic or footprint changed. ECO-006 and a J1 mechanical-interface release are required before another power-selection reissue; CSR-01B remains unauthorized.
