...
QER-01 subsequently released the quantitative envelope, and CSR-01A-R reattempted the freeze. Nine independent 100 kΩ Sheet 02/08 bias/enable resistors are frozen. ECO-006 removed the capacitor/MOSFET rating conflicts, replaced U706/U707/U801 composites with physical selectable functions, and completed schematic-level regulator/passive/transient definition. MIR-01 then released the J1 physical interface and H01 harness requirements. CSR-01A-R2 Power Component Selection Final Pass is authorized; CSR-01A-R remains not accepted, native ERC remains open, and CSR-01B, footprints, and PCB work remain unauthorized.
