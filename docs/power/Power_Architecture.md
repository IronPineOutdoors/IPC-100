...
The 5 V rail is generated by a wide-input buck regulator selected for the verified 9–21 V normal operating range, the approved transient-survival profile, and a preliminary input-path target of at least 2.0 A continuous controller-side current at 9 V. Final approval depends on the complete power budget, rail peak load, efficiency, thermal environment, availability, and layout constraints.
