...
| J10 | Controlled local I2C expansion | 4 logical | `EXPANSION_VCC`, `GND`, `J10_I2C_SDA`, `J10_I2C_SCL` | Optional but fault-relevant | 3.3 V, 100 mA maximum, main-qualified | One approved accessory; 0.30 m maximum inside one enclosure; intentional live mating prohibited | Optional/DNP | Segmented 100 kHz contract, pull-ups, protection, partial-power, and recovery fixed by ICD-001 | Family, physical pin numbering, keying, retention, and harness release remain Sheet 09 work | Electrical contract released; connector pending |
