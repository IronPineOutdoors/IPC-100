...
| ODI-SCH-028 | Composite-function physical decomposition | Replace each composite preliminary block with a reviewed physical-device topology and one-to-one manufacturer-symbol mapping without changing frozen behavior | ECO-011A1R closes Sheet 04 and ECO-011A2 closes Sheet 05; ECO-011A3 found ADR-044's 40 ms boundary lacks a realizable tolerance guard band | CSR-01-F01; ECO-011A1R; ECO-011A2; ECO-011A3 | Before CSR reissue | Open; Sheet 06 blocked on narrow timing resolution |
| ODI-SCH-029 | Project-wide annotation | Assign unique project-level references across Sheets 01–09 and validate stable BOM identity | ECO-005 normalized 288 non-connector references into deterministic sheet ranges, preserved connector/DFT identifiers, and regenerated the 301-row EBOM with zero repeats | CSR-01-F02; ECO-005; Reference Designator Register; EBOM | ECO-005 | Closed; global uniqueness and sheet-range validation added |
| ODI-SCH-030 | Component quantitative prerequisites | Close power/current/transient/thermal, safety threshold/timing, relay load/life, partial-power and connector stress contracts needed for derating | QER-01 now controls the input surge/source envelope, rail/load allocations, simultaneous limits, thermal limits, stability/effective-capacitance criteria, brownout timing, connector capability, signal limits and derating policy; exact-part calculations and prototype evidence remain under their implementation items | CSR-01-F03; CSR-01A-F01–F06; QER-01; ODI-PWR/OUT/INP/CONN items | QER-01 | Closed as a requirements-definition blocker; CSR-01A-R authorized |
| ODI-SCH-031 | Exact module and connector release | Release orderable OLED, sensor, UI loads, J1–J10/J13 connector families and DFT target mechanics | MIR-01 closes the J1 physical requirements and authorizes exact selection in CSR-01A-R2; other connector/module families and DFT mechanics remain later subsystem work | CSR-01-F05; ICD-002; MIR-01 | Before applicable CSR pass | Partially closed; J1 mechanical blocker closed |
| ODI-SCH-032 | Exact-part AVL and cost verification | Verify every row's order code, datasheet revision, pin mapping, ratings, lifecycle, RoHS, stock, alternates and volume pricing | CSR-01A-R closes this evidence for nine 100 kΩ rows; ECO-006 increases power scope to 130 rows and leaves 121 rows for CSR-01A-R2 exact-candidate evidence | CSR-01-F04/F07; CSR-01A-R-F06; EBOM/AVL | Before complete CSR acceptance | Open; Major component-freeze blocker |
| ODI-SCH-033 | CSR-01A-R power implementation alignment | Correct the four captured 50 V input capacitors and 60 V reverse FET against QER-01; decompose U706/U707/U801; complete regulator, transient, passive, thermal and tolerance calculations | ECO-006 removed incompatible ratings, replaced composite symbols with one-device physical classes, and defined selectable requirements without changing frozen interfaces | CSR-01A-R-F01–F04; QER-01; ECO-006 | ECO-006 | Closed; CSR-01A-R2 authorized, exact candidates pending |
| ODI-SCH-034 | CSR-01A-R2 exact-device compatibility | Reconcile U201/R201 frequency programming, TPS2553-Q1 branch-limit programming, and U801 threshold/hysteresis implementation before exact power freeze | Manufacturer datasheets show the released values/functions cannot all be met by the reviewed candidate devices; component selection cannot correct schematic values or add circuitry | CSR-01A-R2-F01–F03; QER-01; ECO-006 | Before power-freeze reissue | Open; Critical corrective ECO required |
