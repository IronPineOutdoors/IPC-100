...
| ODI-SCH-013 | Sheet 05 motion-interface package alignment | Reconcile Package 06 PAN/TILT/position/Sheet 06 requests with the frozen eight-channel external-driver interface; dispose of orphan `OUTPUT_FAULT_SUMMARY` | Sheet 05 cannot invent GPIOs, duplicate limit ownership, or route commands to a non-consumer | ADR-040; ADR-042; External Safety ICD; hierarchy; quantitative motor-interface contract; Package 06 entry-gate review | Before Sheet 05 capture | Open; AR-05 required before Package 06R |
