...
| ODI-SCH-010 | Sheet 03 `MAIN_POWER_GOOD` termination | Confirm MCU observability and assign a unique GPIO or remove/define another approved Sheet 03 consumer without breaking USB-only recovery | ADR-040 allocates or reserves every GPIO but retains the Sheet 03 input without a termination | ADR-039; ADR-040; ESP32 GPIO Allocation Table; Package 04R implementation review | Before Sheet 03 capture | Open; Package 04R stopped before schematic modification |
