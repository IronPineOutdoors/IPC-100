...
| ODI-CPU-002 | GPIO sufficiency | Amend the 27-signal direct plan to allocate the four ADR-039 power-request outputs and disposition any displaced functions, J11, and inhibit diagnostics | Prevents resource overcommitment and duplicate or strap-pin assignments | GPIO map, ADR-039, connectors, expansion, Package 04 entry-gate review | Before MCU schematic | Blocked: four required request outputs have no approved GPIO assignments |
...
| ODI-CPU-004 | USB and recovery implementation | Implement native USB Serial/JTAG, GPIO0/EN manual recovery, and reserved UART0 GPIO43/44 fixture access; approve VBUS, Sheet 03/09 ownership, and production workflow | Affects processor, GPIO, power, service behavior | J13, GPIO Allocation Review, power, Package 04 entry-gate review | Before MCU schematic | Pin resources selected; connector/protection ownership and physical implementation TBD |
