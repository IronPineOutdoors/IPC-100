...
| ODI-CPU-004 | USB and recovery implementation | Implement native USB Serial/JTAG, GPIO0/EN manual recovery, and reserved UART0 GPIO43/44 fixture access; approve VBUS and production workflow under ADR-040 ownership | Affects processor, GPIO, power, service behavior | J13, GPIO Allocation Review, ADR-040, power | Before MCU schematic | Sheet 03/09 ownership and pin resources resolved; physical implementation TBD |
