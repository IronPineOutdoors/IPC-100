...
| ODI-OUT-002 | Motor-driver compatibility | Validate the selected 5 V SN74LXC8T245 interface, 33 Ω series/10 kΩ defaults, 20 kHz preliminary PWM, grounding, cable, and powered-off behavior against intended modules | Reference signaling is not universal compatibility | J2, J3, external drivers | Before schematic release | Quantified for capture; module compatibility validation open |
