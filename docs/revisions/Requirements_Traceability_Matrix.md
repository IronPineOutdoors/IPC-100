...
| PWR-011–PWR-013 | USB interaction and battery measurement | Power/service/ADC | `USB_5V_PROTECTED`, `CORE_SOURCE`, `BATTERY_SENSE` | Power Architecture Engineering Review; GPIO Map | Analysis/test | Bounded USB-only service, backfeed, source transition, and calibration concepts | Before schematic/prototype | Architecture fixed; implementation TBD | ODI-CPU-004, ODI-PWR-004, ODI-PWR-005, ODI-PWR-009 |
| CPU-001–CPU-006 | Processor family, service, resources, memory, boot, antenna | Processor | ESP32-S3-WROOM-1 preferred family, native USB preference, boot/reset | Hardware Requirements; Processor Feasibility; Processor Selection Study | Inspection/analysis/test | Processor gate | Before schematic/firmware | Preferred/Proposed/TBD | ODI-CPU-001–ODI-CPU-006 |
