...
| PWR-006–PWR-010 | Input-path capability, derating, protection, and rail selection | Power architecture | `VIN_RAW`, `VIN_PROTECTED`, `+5V_MAIN`, `CORE_SOURCE`, `+3V3_CORE` | Hardware Requirements; Power Architecture Engineering Review; Schematic Hierarchy Definition; Power Budget | Analysis/test | Power and thermal concepts | Before/during schematic | Architecture/ownership fixed; quantitative design TBD | ODI-PWR-001, ODI-PWR-002, ODI-PWR-008, ODI-SCH-001 |
| PWR-011–PWR-013 | USB interaction and battery measurement | Power/service/ADC | `USB_5V_PROTECTED`, `CORE_SOURCE`, `BATTERY_SENSE` | Power Architecture Engineering Review; GPIO Allocation Review | Analysis/test | Bounded USB-only service, backfeed, source transition, ADC1, and calibration concepts | Before schematic/prototype | Architecture/allocation fixed; implementation TBD | ODI-CPU-004, ODI-CPU-007, ODI-PWR-004, ODI-PWR-005, ODI-PWR-009 |
| CPU-001–CPU-006 | Processor family, service, resources, memory, boot, antenna | Processor | ESP32-S3-WROOM-1 preferred family; proposed 27-signal map; native USB and UART0 recovery | Hardware Requirements; Processor Selection Study; GPIO Allocation Review; Schematic Hierarchy Definition | Inspection/analysis/test | Processor and pin-release gate | Before MCU schematic/firmware | Family/resource/sheet plan selected; exact variant and implementation TBD | ODI-CPU-001–ODI-CPU-006, ODI-SCH-001, ODI-SCH-004 |
...
| INP-001–INP-004 | Stable limit, encoder, ARM/FIRE/STOP interfaces | Inputs | All stable input names | Hardware Requirements; Connector Specification; Safety Input Architecture Review | Inspection/test | Input classifications/contracts | Architecture/schematic | Architecture selected | ODI-INP-001–ODI-INP-003 |
| INP-005–INP-009 | Protection, filtering, states, independence, diagnostics | Safety-relevant inputs | Individually returned supervised NC limits | Safety Input Architecture Review; Wiring; Test Plan | Inspection/analysis/demonstration/test | Input fault concepts | Before schematic/prototype | Architecture selected; quantitative TBD | ODI-INP-001–ODI-INP-005, ODI-INP-007–ODI-INP-008 |
| INP-010–INP-016 | Encoder and ARM/FIRE/STOP behavior and faults | Input abstraction/safety | Non-safety encoder; sequenced NO ARM/FIRE; supervised NC STOP | Safety Input Architecture Review; Hardware/Functional Requirements | Inspection/analysis/demonstration/test | Control and safety concepts | Schematic/firmware | Architecture selected; timing TBD | ODI-INP-001, ODI-INP-005–ODI-INP-006, ODI-INP-009 |
| INP-017–INP-022 | GPIO protection, backfeed, field contract, bias, priority | Input electrical architecture | Protected conditioned external inputs | Safety Input Architecture Review; Hardware Requirements; GPIO Map | Inspection/analysis/test | Fault and startup concepts | Before schematic | Architecture selected; implementation TBD | ODI-INP-001–ODI-INP-009 |
| OUT-001–OUT-003 | Isolated externally powered relay interface | Relay | `RELAY_NC`, `RELAY_COM`, `RELAY_NO` | Output Electrical Architecture Review; Hardware Requirements; J9 | Inspection/analysis/test | Relay ownership/contact concepts | Before schematic | Architecture selected; ratings TBD | ODI-OUT-001, ODI-OUT-009 |
| OUT-004–OUT-008 | Two motor logic channels, RGB, buzzer | Outputs/UI | Axis, RGB, buzzer signals | Output Electrical Architecture Review; J2/J3/J8 | Inspection/analysis/test | Output classifications/contracts | Architecture/schematic | Architecture selected; quantitative TBD | ODI-OUT-002–ODI-OUT-007 |
| OUT-009–OUT-012 | Relay safe state, command gate, final contract | Relay safety | `RELAY_CTRL`, contacts | Output Electrical Architecture Review; Hardware/Functional Requirements | Inspection/analysis/test | Master-inhibited de-energized relay concepts | Before schematic/prototype | Architecture selected; implementation TBD | ODI-OUT-001, ODI-OUT-009–ODI-OUT-010 |
| OUT-013–OUT-020 | Motor safe states, command conflict, STOP/limit, backfeed, contract | Motor safety/interface | Axis signals | Output Electrical Architecture Review; Processor Feasibility | Inspection/analysis/test | Master inhibit, disabled/coast, reversal, priority | Before schematic/prototype | Architecture selected; electrical/timing TBD | ODI-OUT-002–ODI-OUT-005 |
| OUT-021–OUT-028 | RGB/buzzer safe states and unresolved load contracts | Indicators | RGB/buzzer | Output Electrical Architecture Review; Power Budget | Inspection/analysis/demonstration/test | Main-only off/silent defaults | Schematic/prototype | Architecture selected; loads TBD | ODI-OUT-006, ODI-OUT-007 |
| OUT-029–OUT-034 | General safe outputs, command faults, diagnostics, power states/backfeed | Output safety | All outputs | Output Electrical Architecture Review; Power Architecture | Inspection/analysis/demonstration/test | Safe-start/backfeed/fault concepts | Before schematic/prototype | Architecture selected; implementation TBD | ODI-OUT-003, ODI-OUT-008, ODI-PWR-004, ODI-PWR-005 |
...
| EXP-017–EXP-021 | Spare GPIO safety, state, capability and protection | Spare expansion | J11 | Hardware Requirements; GPIO Map; GPIO Allocation Review | Inspection/analysis/test | Spare-GPIO concepts | Before schematic/prototype | Required behavior locked; physical allocation not satisfied | ODI-EXP-002 |
...
| DOC-001, DOC-002 | Controlled naming, revision records, and implementation gates | Configuration control | All | Hardware Requirements; Revision History; Schematic Hierarchy Definition | Inspection | Documentation/hierarchy audit | All stages | Locked; hierarchy/capture gates defined | ODI-SCH-001–ODI-SCH-006 |
...
| FUNC-CPU-001–FUNC-CPU-006 | Processor, service, recovery, resources | Processor Feasibility; GPIO Allocation Review; processor gate | Proposed map complete; exact module/memory and implementation TBD |
| FUNC-IO-001–FUNC-IO-030 | Input/output abstraction, safety, faults, backfeed | GPIO, connectors, Safety Input and Output Electrical Architecture Reviews, test concepts | Input/output behavior selected; quantitative electrical contracts TBD |
