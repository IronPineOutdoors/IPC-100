...
| PWR-006–PWR-010 | Input-path capability, derating, protection, and rail selection | Power architecture | `VIN_RAW`, `VIN_PROTECTED`, `+5V_MAIN`, `CORE_SOURCE`, `+3V3_CORE` | Hardware Requirements; Power Architecture Engineering Review; Power Budget | Analysis/test | Power and thermal concepts | Before/during schematic | Architecture fixed; quantitative design TBD | ODI-PWR-001, ODI-PWR-002, ODI-PWR-008 |
...
| CPU-001–CPU-006 | Processor family, service, resources, memory, boot, antenna | Processor | ESP32-S3-WROOM-1 preferred family; proposed 27-signal map; native USB and UART0 recovery | Hardware Requirements; Processor Feasibility; Processor Selection Study; GPIO Allocation Review | Inspection/analysis/test | Processor and pin-release gate | Before MCU schematic/firmware | Family/resource plan selected; exact variant and implementation TBD | ODI-CPU-001–ODI-CPU-006 |
