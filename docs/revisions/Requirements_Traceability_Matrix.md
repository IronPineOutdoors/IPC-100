...
| FUNC-IO-001–FUNC-IO-030 | Input/output abstraction, safety, faults, backfeed | GPIO, connectors, Safety Input Architecture Review, test concepts | Input behavior selected; quantitative inputs and output electrical contracts TBD |
