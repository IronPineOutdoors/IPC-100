...
foreach($row in $rows|Sort-Object Sheet,Reference){
 ...
 elseif($row.Risk -match 'exact dielectric|device equation'){$cat='Dependent passive';$evidence='Effective-C, ripple/ESR, tolerance/tempco, pulse, timing and stability envelope / HIGH-MEDIUM';$dep='Exact curves/order code, commercial and prototype evidence';$route='PAS-01 / READY FOR PAS-01';$impact='Package family may vary / low'}
 else{$cat='Active-stage/thermal';$evidence='Operating-corner, loss, thermal, switch, timing and PCB envelope / MEDIUM';$dep='Exact order code/package, vendor tool, commercial and prototype evidence';$route='PAS-01 / READY FOR PAS-01';$impact='Thermal land/package unresolved / medium'}
...
$lines.Add('');$lines.Add('- READY FOR PPC-01: 19');$lines.Add('- READY FOR PAS-01: 104');$lines.Add('- READY FOR JCS-01: 1');$lines.Add('- READY FOR CSR-01A-R5 directly: 0');$lines.Add('- Total: 124, exactly once.')
