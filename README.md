...
Rev A uses an ESP32-WROOM-32E or approved compatible module with Wi-Fi, Bluetooth, and ESP-NOW. IPC-100 accepts 9–21 V DC, creates 5 V and 3.3 V logic rails, and provides USB-C diagnostics, battery monitoring, protected inputs, OLED and BME280 interfaces, two low-current external motor-driver interfaces, isolated relay contacts, RGB and buzzer outputs, I2C expansion, spare GPIO, and future CAN/RS485 provisions.
